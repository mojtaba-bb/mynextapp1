...
export default function Analystic(attrs) {
  ...
  return (
    <div className={attrs.className}>
        ...
        <div className="saleQ bg-white basis-1/3 rounded-3xl px-5 flex drop-shadow-xl w-full 2xl:w-max justify-between dark:bg-gray-800 dark:text-gray-100">
          ...
          <CircleRadialBar
            className="font-sans text-gray-700 text-xl font-extrabold stroke-orange-500"
            circleWidth={200}
            percentage ={50}
            textclassName="circle-text"
            storkeWidth= {20}
        ...
        <div className="siteVQ bg-white basis-1/3  my-5 2xl:mx-5 2xl:my-0  w-full 2xl:w-max  rounded-3xl  px-5 dark:bg-gray-800 justify-between dark:text-gray-100 flex  drop-shadow-xl">
          ...
          <CircleRadialBar
            className="font-sans text-gray-700 text-xl font-extrabold stroke-rose-600 "
            circleWidth={200}
            percentage ={70}
            textclassName="circle-text"
            storkeWidth= {20}
        ...
        <div className="searchQ bg-white basis-1/3  rounded-3xl  w-full 2xl:w-max  px-5 flex drop-shadow-xl justify-between dark:bg-gray-800 dark:text-gray-100">
          ...
          <CircleRadialBar
            className="font-sans text-gray-700 text-xl font-extrabold stroke-cyan-500"
            circleWidth={200}
            percentage ={-30}
            textclassName="circle-text dark:text-gray-300"
            storkeWidth= {20}
          />
        </div>
      </div>
      <div className="newUsers mb-5">
        ...
        <div className="users bg-white dark:bg-gray-800 dark:text-gray-200 rounded-3xl my-5 flex justify-evenly drop-shadow-xl">
          ...
          <div className="tablerow flex-col lg:flex-row flex h-fit  basis-1/2 justify-evenly items-center">
            <Usercart image={User3.src} name="Reza" time="recently" />
            <div className="ShowMore text-center w-fit p-5 basis-2/5 flex flex-col justify-center items-center cursor-pointer">
              ...
              <span className="text-2xl font-bold block mt-2 text-gray-700 dark:text-gray-200 ">
                More
              </span>
      ...
      <div className="resentOrders mb-5">
            ...
            <div className="p-5 bg-white dark:bg-gray-800 rounded-3xl my-5  flex  flex-col drop-shadow-xl ">
              ...
              <ul className="childs grid grid-flow-row w-full text-center   text-gray-500 divide-y dark:text-gray-200  ">
                <li className="pt-5 child">
                  <ul className="flex  text-center">
                    <li className="courseName basis-1/5  pointer-events-none">
                      JavaScript Tutorial
                    </li>
                    <li className="courseNumber basis-1/5 pointer-events-none">
                      85743
                    </li>
                    <li className="payment basis-1/5 pointer-events-none">
                      Due
                    </li>
                    <li className="status basis-1/5 text-yellow-600 pointer-events-none">
                      Pending
                    </li>
                    <li className="detail basis-1/5 cursor-pointer text-blue-600 hover:text-blue-900">
                      Details
                    </li>
                  </ul>
                </li>
                <li className="pt-5 child">
                  <ul className="flex  text-center">
                    ...
                    <li className="status basis-1/5 text-red-600 pointer-events-none">
                      Decliend
                    </li>
                    <li className="detail basis-1/5 cursor-pointer text-blue-600 hover:text-blue-900">
                      Details
                ...
                <li className="pt-5 child">
                  <ul className="flex  text-center">
                    ...
                    <li className="status basis-1/5 text-green-600 pointer-events-none">
                      Active
                    </li>
                    <li className="detail basis-1/5 cursor-pointer text-blue-600 hover:text-blue-900">
                      Details
              ...
              <span
                className="showMoreBtn text-center absolute top-full right-1/2 translate-x-1/2 translate-y-5 text-blue-600 cursor-pointer "
                onClick={resentordersMore}
              >
                Show All
              </span>
            </div>
